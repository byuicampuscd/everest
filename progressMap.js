...
var progressMap = (function () {
   ...
   var pics = [
      {fileName: 'percentBadge05.png',  x: 500,   y: 301, dx: 50, dy: -50, scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge10.png',  x: 47,   y: 163, dx: 50, dy: 0,   scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge15.png',  x: 174,  y: 133, dx: 0,  dy: 0,   scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge20.png',  x: 209,  y: 303, dx: 0,  dy: -50, scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge25.png',  x: 343,  y: 226, dx: 0,  dy: 0,   scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge30.png',  x: 256,  y: 200,  dx: 0,  dy: 50,  scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge35.png',  x: 357,  y: 124, dx: 0,  dy: 0,   scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge40.png',  x: 437,  y: 200,  dx: 0,  dy: 50,  scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge45.png',  x: 545,  y: 200,  dx: 0,  dy: 30,  scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge50.png',  x: 450,  y: 171, dx: 0,  dy: 0,   scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge55.png',  x: 483,  y: 282, dx: 0,  dy: -30, scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge60.png',  x: 584,  y: 272, dx: 0,  dy: -20, scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge65.png',  x: 624,  y: 169, dx: 0,  dy: 0,   scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge70.png',  x: 715,  y: 265, dx: 0,  dy: -15, scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge75.png',  x: 762,  y: 200,  dx: 0,  dy: 20,  scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge80.png',  x: 884,  y: 200,  dx: 0,  dy: 10,  scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge85.png',  x: 838,  y: 210, dx: 0,  dy: 0,   scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge90.png',  x: 938,  y: 152, dx: 0,  dy: -40, scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge95.png',  x: 970,  y: 147, dx: 0,  dy: 0,   scalePic: 0.15, animateScale: 2},
      {fileName: 'percentBadge100.png', x: 1005, y: 200,  dx: 0,  dy: 50,  scalePic: 0.15, animateScale: 2}
   ],
      backgroundPic = {
